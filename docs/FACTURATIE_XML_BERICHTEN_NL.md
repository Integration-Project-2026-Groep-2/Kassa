# Facturatie - XML Berichten van Kassa (v1.9)
...
- Builder: `src/messaging/message_builders.py`
- Sender: `kassa_pos/utils/rabbitmq_sender.py`
- Trigger: `kassa_pos/models/pos_order.py`
...
- Builder: `src/messaging/message_builders.py`
- Service: `kassa_pos/services/pos_batch_service.py`
- Trigger: `kassa_pos/models/pos_order.py`
...
### Voor BatchClosed via topic exchange
...
### Voor InvoiceRequested via default exchange
...
- `src/schema/kassa-closed-batch.xsd`
...
- `kassa_pos/models/pos_order.py`
- `kassa_pos/services/pos_batch_service.py`
- `src/messaging/message_builders.py`
- `src/config.py`
...
|---|---|---|
| 1.9 | 2026-05-13 | Initiële documentatie voor facturatie XML-berichten |
